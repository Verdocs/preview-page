...
/** @type {?} */
var VSDKConfigToken = new InjectionToken('VSDKConfig');
...
function roleNameValidator(roles) {
    ...
    function (control) {
        /** @type {?} */
        var duplicateRoleName = find(roles, { name: control.value });
...
function TagDuplicateValidator(tags) {
    ...
    function (control) {
        /** @type {?} */
        var duplicateIndex = findIndex(tags, { tag_name: control.value });
