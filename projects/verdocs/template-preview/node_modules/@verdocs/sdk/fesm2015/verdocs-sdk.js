...
import { Injectable, Inject, Injector, PLATFORM_ID, InjectionToken, NgModule } from '@angular/core';
import { HttpRequest, HttpResponse, HttpHeaders, HttpClient } from '@angular/common/http';
import { VerdocsAuthService, VerdocsAuthGuardService, VerdocsStateService, VerdocsTokenObjectService, TokensModule, VTokenConfigToken } from '@verdocs/tokens';
import { DOCUMENT, isPlatformBrowser } from '@angular/common';
import { BehaviorSubject, empty, ReplaySubject, throwError, from, forkJoin, of, Subject, Observable, EMPTY } from 'rxjs';
import { map, concatMap, catchError, mergeMap, delay } from 'rxjs/operators';
import { differenceBy, findIndex, intersection, filter, find } from 'lodash';
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class TemplatesRemindersService {
    /**
     * @param {?} http
     * @param {?} injector
     */
...
/** @type {?} */
const VSDKConfigToken = new InjectionToken('VSDKConfig');
class AngularApiModule {
    /**
     * @param {?} config
     * @return {?}
     */
...
export { AngularApiModule, AuthGuardService, BuilderService, DocumentSortOptions, DocumentsService, EnvelopRemindersService, FieldData, PhoneValidator, RecipientService, SortOptions, TagDuplicateValidator, TagErrorStateMatcher, TagValidator, TemplateActions, TemplatePermissions, TemplateSenderTypes, TemplatesGuardService, TemplatesRemindersService, TemplatesService, VSDKConfigToken, ValidatorService, countries, getCountryByCode, getMatchingCountry, getPlusOneCountry, getRGB, getRGBA, isAmericanSamoa, isCanada, isDominicanRepublic, isFrenchGuiana, isGuadeloupe, isMartinique, isMayotte, isPuertoRico, nameToRGBA, regParse, roleNameValidator, simpleE164Validator };
//# sourceMappingURL=verdocs-sdk.js.map
