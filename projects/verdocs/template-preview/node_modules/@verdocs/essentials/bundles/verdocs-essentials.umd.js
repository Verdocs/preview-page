(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@verdocs/sdk'), require('lodash'), require('print-js'), require('@angular/core'), require('@angular/common'), require('@angular/material/snack-bar'), require('@angular/common/http'), require('@angular/router'), require('rxjs'), require('@verdocs/tokens'), require('@verdocs/profiles'), require('@angular/material/dialog'), require('rxjs/operators'), require('@verdocs/event-tracker'), require('uuid'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('@verdocs/essentials', ['exports', '@verdocs/sdk', 'lodash', 'print-js', '@angular/core', '@angular/common', '@angular/material/snack-bar', '@angular/common/http', '@angular/router', 'rxjs', '@verdocs/tokens', '@verdocs/profiles', '@angular/material/dialog', 'rxjs/operators', '@verdocs/event-tracker', 'uuid', '@angular/platform-browser'], factory) :
    (global = global || self, factory((global.verdocs = global.verdocs || {}, global.verdocs.essentials = {}), global.sdk, global.lodash, global.printJS, global.ng.core, global.ng.common, global.ng.material['snack-bar'], global.ng.common.http, global.ng.router, global.rxjs, global.tokens, global.profiles, global.ng.material.dialog, global.rxjs.operators, global.eventTracker, global.uuid, global.ng.platformBrowser));
}(this, function (exports, sdk, lodash, printJS, core, common, snackBar, http, router, rxjs, tokens, profiles, dialog, operators, eventTracker, uuid, platformBrowser) { 'use strict';

    printJS = printJS && printJS.hasOwnProperty('default') ? printJS['default'] : printJS;
    ...
    ***************************************************************************** */
    ...
    function updateElementStyles(fields, _fields, mode, browserType) {
        if (fields && _fields && fields.length === _fields.length) {
            for (var x = 0; x < _fields.length; x++) {
                /** @type {?} */
                var fieldIndex = lodash.findIndex(fields, { name: _fields[x].field_name });
                if (fieldIndex >= 0) {
            ...
            for (var i = 0; i < pages.length; i++) {
                ...
                for (var j = 0; j < pages[i].fields.length; j++) {
                    if (pages[i].fields[j]['setting'] && pages[i].fields[j]['setting']['options'] &&
                        ...
                        /** @type {?} */
                        var copyIndex = lodash.findIndex(fieldPages[i].fields, { name: fieldCopy.name });
    ...
    function constructGroupFields(pages, i, j, roles, pdfPages, fieldPages, browserType) {
        ...
        while (k < optionsLength) {
            ...
            /** @type {?} */
            var copyIndex = lodash.findIndex(fieldPages[i].fields, { optionIndex: fieldCopy.optionIndex, name: fieldCopy.name });
            if (copyIndex < 0) {
                fieldPages[i].fields[fieldPages[i].fields.length] = fieldCopy;
            }
            k++;
    ...
    function getRoleColor(name, roles, index) {
        if (index) {
            return sdk.getRGBA(index);
        }
        else if (roles && roles.length > 0) {
            index = lodash.findIndex(roles, { name: name });
            if (index >= 0) {
                return roles[index].rgba ? roles[index].rgba : sdk.getRGBA(index);
            }
            else {
                return sdk.nameToRGBA(name);
            }
        }
        else {
            return sdk.nameToRGBA(name);
    ...
    var BuilderDataService = /** @class */ (function () {
        function BuilderDataService(http, router, templatesService, templateGuard, snackbarService, eventTracker, injector) {
            ...
            this.recipients = [];
            this.roles = [];
            this.templateSubject = new rxjs.ReplaySubject(1, 500);
            this.hasFields = false;
            this.templateNameSubject = new rxjs.ReplaySubject(1, 500);
            this.templatePagesSubject = new rxjs.ReplaySubject(1, 500);
            this.recipientsSubject = new rxjs.ReplaySubject();
            this.activeRecipientSubject = new rxjs.ReplaySubject();
            this.scrollInfoSubject = new rxjs.ReplaySubject();
            this.screenInfoSubject = new rxjs.ReplaySubject();
            this.newTypeSubject = new rxjs.Subject();
            this.newOptionSubject = new rxjs.ReplaySubject(1, 100);
            this.duplicateFieldSubject = new rxjs.ReplaySubject();
            this.saveStatusSubject = new rxjs.ReplaySubject();
            this.renderedSubject = new rxjs.ReplaySubject();
            this.activeFieldIndexSubject = new rxjs.ReplaySubject(1, 100);
            this.numberOfRolesSubject = new rxjs.ReplaySubject();
            this.numberOfSequenceSubject = new rxjs.ReplaySubject();
            this.hasFieldsSubject = new rxjs.ReplaySubject();
         ...
         */
        function (template_body) {
            return this.templatesService.updateTemplateObservable(template_body.id, template_body).pipe(operators.map((/**
             * @param {?} template
             * @return {?}
             */
         ...
         */
        function () {
            return this.templateSubject.pipe(operators.map((/**
             * @param {?} template
             * @return {?}
             */
            function (template) { return template; })));
        ...
        function (file, template) {
            ...
            /** @type {?} */
            var req = new http.HttpRequest('POST', this.rForm_backend_url + '/templates/' + template.id + '/documents', formdata, {
                reportProgress: true
            });
        ...
        function (templateId) {
            var _this = this;
            this.templateDoc = this.templatesService.getAllTemplateDocumentsObservable(templateId).pipe(operators.map((/**
             * @param {?} docs
             * @return {?}
             */
            function (docs) {
        ...
        function (templateId, templateDoc) {
            if (templateId && templateDoc) {
                return this.templatesService.getTemplateDocumentPDFObservable(templateId, templateDoc).pipe(operators.map((/**
                 * @param {?} pdf
                 * @return {?}
                 */
                function (pdf) {
        ...
        function (document, pageNums, templateId) {
            ...
            function (pageNum) {
                ...
                return (/** @type {?} */ (_this.http.post(_this.rForm_backend_url + ("/templates/" + templateId + "/pages"), page).pipe(operators.delay(200))));
            })));
        };
        /**
         * @param {?} template
                ...
                try {
                    for (var fieldNames_1 = __values(fieldNames), fieldNames_1_1 = fieldNames_1.next(); !fieldNames_1_1.done; fieldNames_1_1 = fieldNames_1.next()) {
                        ...
                        for (var x = 0; x < pages.length; x++) {
                            /** @type {?} */
                            var fieldIndex = lodash.findIndex(pages[x].fields, { name: fieldName });
                            if (fieldIndex >= 0) {
        ...
        function (name, index, template) {
            if (index !== null && index > -1) {
                ...
                if (template.roles && template.roles.length > 0) {
                    index = lodash.findIndex(template.roles, { name: name });
                    if (index >= 0) {
                        return template.roles[index].rgba ? template.roles[index].rgba : sdk.getRGBA(index);
                    }
                }
                else {
                    return sdk.nameToRGBA(name);
        ...
        function (template) {
            /** @type {?} */
            var response = this.templateGuard.canPerformAction(sdk.TemplateActions.WRITE, template);
        ...
        function (template) {
            var e_4, _a;
            /** @type {?} */
            var hasPermission = (this.templateGuard.canPerformAction(sdk.TemplateActions.READ, template)).canPerform;
            /** @type {?} */
            var canPreview;
            /** @type {?} */
        ...
        BuilderDataService.ctorParameters = function () { return [
            ...
            { type: router.Router },
            { type: sdk.TemplatesService },
            { type: sdk.TemplatesGuardService },
    ...
    var BuilderService = /** @class */ (function () {
        function BuilderService() {
            ...
            this.recipientSideNavStateSubject = new rxjs.ReplaySubject(1, 100);
            this.initiateAutofocus = new rxjs.ReplaySubject();
            this.recipientAutoFocus = new rxjs.ReplaySubject();
            this.deleteRoleSubject = new rxjs.ReplaySubject(1, 100);
            this.hasActiveRoleSubject = new rxjs.ReplaySubject();
        }
        // constructor() {}
        // constructor() {}
        /**
    ...
    var SignatureService = /** @class */ (function () {
        function SignatureService(httpClient, injector, envelopeSvc, vTokenStateService) {
            ...
            this.workingField = new sdk.FieldData({ order: 0, fName: '' });
            this.fields = [];
            this._total = -1;
            this._fields = new rxjs.ReplaySubject();
            this._recipient = new rxjs.ReplaySubject();
            this._showSig = new rxjs.ReplaySubject();
            this._signedFields = new rxjs.BehaviorSubject({});
            this._envId = new rxjs.ReplaySubject();
            this._rName = new rxjs.ReplaySubject();
            this.signImgSubject = new rxjs.ReplaySubject();
            this.initialImgSubject = new rxjs.ReplaySubject();
            this.initialIdSubject = new rxjs.ReplaySubject();
            this.signatureIdSubject = new rxjs.ReplaySubject();
            this.signedFields = {};
            this.mode = '';
            this._config_token = this.injector.get(EssentialsConfigToken);
    ...
    var EnvelopeViewService = /** @class */ (function () {
        function EnvelopeViewService(signatureService) {
            ...
            this.recipientSubject = new rxjs.ReplaySubject();
            this.jumpCoordinateSubject = new rxjs.ReplaySubject();
            this.fieldTypeSubject = new rxjs.ReplaySubject();
            this.pdfUrlSubject = new rxjs.ReplaySubject();
            this.pdfBlobSubject = new rxjs.ReplaySubject();
            this.toggleNextSubject = new rxjs.ReplaySubject();
            this.viewModeSubject = new rxjs.ReplaySubject();
            this.agreedSubject = new rxjs.ReplaySubject(1, 500);
            this.attachmentsSubject = new rxjs.ReplaySubject();
            this.formValiditySubject = new rxjs.ReplaySubject();
            this.requestFormValiditySubject = new rxjs.ReplaySubject();
    ...
    var PageService = /** @class */ (function () {
        ...
        function () {
             ...
             * @return {?}
             */
            function () { return _this.activatedRoute; })), operators.map((/**
             * @param {?} route
             * @return {?}
             */
            function (route) {
             ...
             * @return {?}
             */
            function (route) { return route.data; })), operators.map((/**
             * @param {?} data
             * @return {?}
             */
            function (data) {
    ...
    var ModalService = /** @class */ (function () {
        ...
        function (id) {
            /** @type {?} */
            var modal = lodash.find(this.modals, { id: id });
        };
        /**
         * @param {?} id
         * @return {?}
    ...
    /** @type {?} */
    var EssentialsConfigToken = new core.InjectionToken('EssentialsConfig');
    ...
    var AccountService = /** @class */ (function () {
        ...
        function (id) {
            /** @type {?} */
            var removeIndex = lodash.findIndex(this.profileData, { organization_id: name });
            if (removeIndex >= 0) {
    ...
    exports.BrowserToiTextService = BrowserToiTextService;
    exports.BuilderDataService = BuilderDataService;
    exports.BuilderService = BuilderService;
    exports.ConversionService = ConversionService;
    exports.DynamicField = DynamicField;
    exports.EnvelopeViewService = EnvelopeViewService;
    exports.ErrorDialogService = ErrorDialogService;
    exports.EssentialsConfigToken = EssentialsConfigToken;
    ...
    exports.PlansDialog = PlansDialog;
    exports.SignatureService = SignatureService;
    exports.SnackbarService = SnackbarService;
    exports.blobToBase64 = blobToBase64;
    exports.bottomOfPageIsInView = bottomOfPageIsInView;
    exports.buildFields = buildFields;
    exports.constructGroupFields = constructGroupFields;
    exports.constructPages = constructPages;
    exports.convertToUIRatio = convertToUIRatio;
    exports.dataURLtoBlob = dataURLtoBlob;
    exports.generateCheckboxLabel = generateCheckboxLabel;
    exports.generateGroupLabel = generateGroupLabel;
    exports.generateInitialStyle = generateInitialStyle;
    ...
    exports.getInputStyle = getInputStyle;
    ...
    exports.getUIFieldStyling = getUIFieldStyling;
    exports.isInView = isInView;
    exports.middleOfPageIsInView = middleOfPageIsInView;
    exports.prepareFieldsForSigner = prepareFieldsForSigner;
    exports.printPdfUrl = printPdfUrl;
    exports.regParse = regParse;
    exports.rescale = rescale;
    exports.setRatio = setRatio;
    exports.timePeriod = timePeriod;
    exports.topOfPageIsInView = topOfPageIsInView;
    exports.updateElementStyles = updateElementStyles;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=verdocs-essentials.umd.js.map
